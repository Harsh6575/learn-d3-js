...
export const AxesRandomFormat = () => {
  const id = "axes-random-format";
  ...
  useEffect(() => {
    ...
    //Define X axis
    let xAxis = d3.axisBottom(xScale).ticks(5).tickFormat(formatAsPercentage);

    //Define Y axis
    let yAxis = d3.axisLeft(yScale).ticks(5).tickFormat(formatAsPercentage);
    ...
    let svg = d3
      ...
      .append("svg")
      .attr("width", w)
      .attr("height", h).style("margin-left", 100);
